          ...
          <>
            ...
            <div className="space-y-6">
              ...
              <div className="brutalist-border p-3 bg-white">
                <h3 className="font-bold mb-3 text-lg uppercase">
                  {t("colorAdjust")}
                </h3>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    ...
                    >
                      {t("saturation")}:{" "}
                      {adjustments.saturation?.toFixed(0) || "100"}
                    </label>
                    <div className="flex items-center">
                  ...
                  <div>
                    <label htmlFor="lightness" className="block mb-1 font-bold">
                      {t("lightness")}:{" "}
                      {adjustments.lightness?.toFixed(0) || "100"}
                    </label>
                    <div className="flex items-center">
              ...
              <div className="brutalist-border p-3 bg-white">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      {t("green")}:{" "}
                      {adjustments.greenScale?.toFixed(2) || "1.00"}
                    </label>
                    <input
                      id="greenScale"
                      type="range"
