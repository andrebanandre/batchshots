...
class MockHTMLCanvasElement {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
  getContext(_contextId: string, _options?: any): MockCanvasRenderingContext2D | null {
...
describe('Image Processing Functions', () => {
  ...
  describe('processImage', () => {
    it('should process an image with default adjustments', async () => {
      ...
      const result = await processImage(mockImageFile, adjustments, null, false);
    ...
    it('should apply preset resize dimensions when provided', async () => {
      ...
      const result = await processImage(mockImageFile, adjustments, preset, true);
